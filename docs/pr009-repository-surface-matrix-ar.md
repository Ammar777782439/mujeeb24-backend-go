...
| Sales | Lead lifecycle/attribution/score وuniversal CommercialTransaction/review/confirmation/order-line snapshots | `leads`, `lead_attributions`, `lead_scores`, `commercial_transactions`, `transaction_reviews`, `transaction_confirmations`, `order_lines` + 000030 reconciliation | **منفذة ومثبتة بـPostgreSQL 16**؛ semantic vertical details وbootstrap مؤجلة |
