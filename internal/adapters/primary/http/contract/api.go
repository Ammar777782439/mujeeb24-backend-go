...
func registerCoreOperations(api huma.API, dispatcher DashboardOperationHandler) {
	...
	register(api, dispatcher, huma.Operation{OperationID: "listAccessibleBusinesses", Method: http.MethodGet, Path: "/me/businesses", Tags: []string{"Me"}, Summary: "List businesses accessible to the principal", Security: dashboardSecurity}, BusinessListInput{}, List[BusinessMembership]{})
...
func registerExtendedOperations(api huma.API, dispatcher DashboardOperationHandler) {
	...
	register(api, dispatcher, huma.Operation{OperationID: "listCatalogs", Method: http.MethodGet, Path: "/businesses/{business_id}/catalogs", Tags: []string{"Catalog"}, Summary: "List catalogs", Security: dashboardSecurity}, BusinessListInput{}, List[Catalog]{})
...
func registerRemainingDashboardOperations(api huma.API, dispatcher DashboardOperationHandler) {
	...
	register(api, dispatcher, huma.Operation{OperationID: "beginChannelConnection", Method: http.MethodPost, Path: "/businesses/{business_id}/channel-connections", Tags: []string{"Connections"}, Summary: "Begin channel connection", Security: dashboardSecurity, DefaultStatus: http.StatusAccepted}, ConnectionCreateInput{}, Single[ChannelConnection]{})
