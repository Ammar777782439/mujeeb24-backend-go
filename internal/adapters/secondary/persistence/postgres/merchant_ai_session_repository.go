...
// errSessionNotFound is returned when a session lookup fails. It is wrapped
// in a RepositoryError with Kind RepositoryNotFound at the call site.
var errSessionNotFound = errors.New("merchant_ai_session not found")
