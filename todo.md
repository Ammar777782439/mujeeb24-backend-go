...
## مرجع AI/Agent وحواجز التحقق

- [x] إنشاء مرجع موحد داخل المستودع يشرح المعمارية الحالية، مصدر الحقيقة، ما أزيل نهائيًا، وما هو منفذ أو مخطط أو غير مثبت.
- [x] إضافة `AGENTS.md` لتوجيه أي AI/Agent إلى المرجع قبل تحليل أو تعديل الكود.
- [x] توثيق أن unit وPostgreSQL integration وprovider contract وlive smoke وproduction readiness حالات مختلفة ولا يجوز الخلط بينها.
- [x] توثيق حظر الأسرار وraw invite tokens وnetwork داخل معاملات PostgreSQL وblind retry والوصول العابر للتجار بلا تدقيق.
- [ ] مراجعة دورية لاتساق المرجع مع الكود وOpenAPI وmigrations وPostman بعد كل milestone.

> لا يقدّم المرجع ضمانًا مطلقًا من الأخطاء؛ هو حاجز معرفة وتحقق، ولا يلغي الاختبارات أو مراجعة الكود أو الموافقة على Git.

> لا تكرر هذا القسم عند التحديث؛ حدّث البنود الحالية فقط.
